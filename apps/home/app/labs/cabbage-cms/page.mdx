...
export const caseStudy = {
  ...
  testimonial: {
    author: { name: 'Debra Fiscal', role: 'CEO of CabbageCMS' },
    content:
...
Having written one of the most shared posts on medium.com (“_How to cash out your Dad’s 401K without him knowing_”) CabbageCMS approached us looking to build out their own blog.
