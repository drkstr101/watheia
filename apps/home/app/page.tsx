    ...
    <div className={styles.page}>
      <div className="w-full">
        <div className="container">
          ...
          <div id="hero" className="rounded-2xl">
          ...
          <div id="middle-content">
            <div id="learning-materials" className="rounded-2xl shadow-xl">
            ...
            <div id="other-links">
              <a
                id="nx-console"
                className="button-pill rounded-2xl shadow-xl"
              ...
              <div id="nx-cloud" className="rounded-2xl shadow-xl">
                <div>
                  <svg
                    id="nx-cloud-logo"
                    role="img"
          ...
          <div id="commands" className="rounded-2xl shadow-xl">
            <h2>Next steps</h2>
