  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <FeaturedPeopleSectionActions
          actions={actions}
          hasTopMargin={!!(badge?.label || title?.text || subtitle || people.length > 0)}
        />
      </div>
    </Section>
  );
...
function FeaturedPeopleThreeCol({ people = [], hasTopMargin, hasSectionTitle }) {
  ...
  return (
    <div
      className={classNames('grid', 'gap-10', 'sm:grid-cols-2', 'lg:grid-cols-3', {
        'mt-12': hasTopMargin,
      })}
...
function FeaturedPeopleFourCol({ people = [], hasTopMargin, hasSectionTitle }) {
  ...
  return (
    <div
      className={classNames('grid', 'gap-10', 'sm:grid-cols-2', 'lg:grid-cols-4', {
        'mt-12': hasTopMargin,
      })}
      data-sb-field-path=".people"
    >
...
function FeaturedPeopleMixedCol({ people = [], hasTopMargin, hasSectionTitle }) {
  ...
  return (
    <div
      className={classNames('grid', 'gap-10', 'sm:grid-cols-2', 'lg:grid-cols-16', {
        'mt-12': hasTopMargin,
      })}
      data-sb-field-path=".people"
    >
