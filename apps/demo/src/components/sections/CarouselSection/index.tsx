...
function CarouselWithNavigation({ items = [], hasTopMargin, hasSectionTitle }) {
  ...
  return (
    <div
      className={classNames('w-full', 'relative', { 'mt-12': hasTopMargin })}
      ...
      >
        {items.map((item, index) => (
          <span
            ...
            className={classNames(
              'sb-carousel-dot',
              activeDot === index ? 'sb-carousel-dot-active' : undefined
            )}
            onClick={() => {
          ...
          <div key={index} data-sb-field-path={`.${index}`}>
            <div
              className={classNames(
                ...
                '',
                activeTab === index ? 'sb-carousel-tab-title-active' : undefined
              )}
