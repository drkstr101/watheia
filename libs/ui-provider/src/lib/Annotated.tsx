...
import { HasAnnotation, fieldPathAttr, objectIdAttr } from '@watheia/content-model';
import { PropsWithChildren } from 'react';

function annotationFromProps(props: any) {
...
const AnnotatedWrapperTag: React.FC<PropsWithChildren & { annotation: HasAnnotation }> = ({
  ...
  const fieldPath = annotation[fieldPathAttr as keyof typeof annotation];
