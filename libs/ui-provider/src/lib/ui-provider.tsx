import { GlobalProps, types } from '@watheia/content-model';
...
type DynamicComponentProps = types.ContentObject & {
  global?: GlobalProps;
};
...
export const DynamicComponent: React.FC<DynamicComponentProps> = (props) => {
  ...
  const Component = components[modelName as keyof typeof components] as ComponentType;
  if (!Component) {
