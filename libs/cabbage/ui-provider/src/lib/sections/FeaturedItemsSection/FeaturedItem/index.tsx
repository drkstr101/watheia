    ...
    >
      <div
        className={classNames(
          'w-full',
          'flex',
          mapFlexDirectionStyles(flexDirection, hasTextContent, hasImage),
          'gap-6'
        )}
      >
        {hasImage && (
            ...
            className={classNames(
              ...
              mapStyles({ justifyContent: styles?.self?.justifyContent ?? 'flex-start' }),
              {
                'xs:w-[28.4%] xs:shrink-0':
                  hasTextContent && (flexDirection === 'row' || flexDirection === 'row-reversed'),
              }
            )}
        ...
        {hasTextContent && (
          <div
            className={classNames('w-full', {
              'xs:grow':
                hasImage && (flexDirection === 'row' || flexDirection === 'row-reversed'),
            })}
          >
            {tagline && (
  ...
  switch (flexDirection) {
    ...
    case 'row-reverse':
      return hasTextContent && hasImage
        ? 'flex-col xs:flex-row-reverse xs:items-start'
        : 'flex-col';
    case 'col':
      return 'flex-col';
    case 'col-reverse':
