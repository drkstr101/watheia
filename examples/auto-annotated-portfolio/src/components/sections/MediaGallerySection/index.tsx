...
import type {
  ...
  MediaGallerySection as MediaGallerySectionProps,
} from '@/types';
  ...
  return (
    ...
    >
      ...
      {showCaption && image.caption && (
        <figcaption className="bg-inverse/70 text-inverse pointer-events-none absolute bottom-2 left-0 mx-2 p-1.5 text-xs">
          {image.caption}
        </figcaption>
      )}
    </figure>
